...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/blue_thermal_printer/blue_thermal_printer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_thermal_printer/flutter_thermal_printer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/qr_bar_code/qr_bar_code.framework"
