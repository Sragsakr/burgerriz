...
class MenuItemTranslationTable {
  MenuItemTranslationTable._();

  static String name = 'menu_item_translation';
  ...
  static Future<List<MenuItemTranslationEntity>> getAll() async {
    final list = await AppDB.read(table: name);
    return list.map((e) => MenuItemTranslationEntity.fromJson(e)).toList();
  }

  static Future<MenuItemTranslationEntity?> getById(int? id) async {
    ...
    return MenuItemTranslationEntity.fromJson(list.first);
  }

  static Future<MenuItemTranslationEntity?> getByEntityId(int? id) async {
    var list = await AppDB.read(
      table: name,
      where: 'id = ?',
      whereArgs: [id],
  ...
  static Future<List<MenuItemTranslationEntity>> getByMenuItemId(
  ...
  static Future<List<MenuItemTranslationEntity>> getByLanguageId(
  ...
  static Future<int> insert(MenuItemTranslationEntity entity) async {
  ...
  static Future<int> update({
    required MenuItemTranslationEntity entity,
    required int id,
  }) async {
  ...
  static Future<void> insertOrUpdate(MenuItemTranslationEntity entity) async {
