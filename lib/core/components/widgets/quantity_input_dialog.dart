...
class QuantityInputDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<QuantityInputDialog> createState() => _QuantityInputDialogState();
}
...
class _QuantityInputDialogState extends ConsumerState<QuantityInputDialog> {
  ...
  void initState() {
    super.initState();
    _barcodeController = TextEditingController(text: widget.value ?? (widget.allowDecimal ? '1.0' : '1'));
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              keyboardType: widget.allowDecimal ? const TextInputType.numberWithOptions(decimal: true) : TextInputType.number,
              ...
              decoration: InputDecoration(
                hintText: translator(arText: 'ادخل الكمية', enText: 'Enter Quantity'),
              ...
              children: [
                ...
                _buildButton(
                  ...
                  onPressed: () {
                    ...
                    if (text.isEmpty) {
                      Navigator.of(context).pop(widget.allowDecimal ? '1.0' : '1');
                      return;
                    }
                    ...
                    if (widget.allowDecimal) {
                      ...
                      if (value != null && value > 0) {
                        ...
                        _showErrorDialog(context, translator(arText: 'يرجى إدخال رقم  أكبر من الصفر', enText: 'Please enter a valid number greater than zero'));
                      }
                    } else {
                      ...
                      if (value != null && value > 0) {
                        ...
                        _showErrorDialog(context, translator(arText: 'يرجى إدخال رقم صحيح أكبر من الصفر', enText: 'Please enter a valid integer greater than zero'));
                      }
                    }
                  },
                ),
